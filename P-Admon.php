		...
		<div class="container1 logo-nav-container">
			...
			<nav class="navegation">
				...
				<ul>
					...
					<li class="Inicio"><a href="asistenciaSalida.php">asisitencia de salida</a></li>
					
					<li class="Inicio"><a href="P-Admon-Llamado-Atencion-Generar.php">Generar Llamado Atencion</a></li>
...
<h1 align="center"  style="color:#00F6FE;"> Asistencia entrada </h1>
   <br />
		...
		<div class="contenedor">
			...
			<div class="barra__buscador">
				<form action="" class="formulario" method="POST">
					...
					<a href="P-AdmonRetardos.php" class="btn" name="btn__nuevo">Generar Retardos</a>
