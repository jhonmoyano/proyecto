		...
		<div class="container1 logo-nav-container">
			...
			<nav class="navegation">
				...
				<ul>
					...
					<li class="Inicio"><a href="asistenciaaseo.php">asisitencia de salida</a></li>
...
<h1 align="center"  style="color:#00F6FE;"> Asistencia entrada personal de aseo</h1>
   <br />
		...
		<div class="contenedor">
			...
			<div class="barra__buscador">
				<form action="" class="formulario" method="POST">
					...
					<a href="llamados_aseo.php" class="btn" name="btn__nuevo">ver llamados de atencion </a>
					<a href="verRetardos_aseo.php" class="btn" name="btn__nuevo">ver retardos  </a>
