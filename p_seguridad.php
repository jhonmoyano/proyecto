...
<html lang="es">
    <head>
        <title>Personal seguridad </title>
        <meta charset="utf-8">
...
<h1 align="center"  style="color:#00F6FE;"> Asistencia Entrada Personal De Seguridad </h1>
   <br />
		...
		<div class="contenedor">
			...
			<div class="barra__buscador">
				<form action="" class="formulario" method="POST">
					...
					<a href="llamados_seguridad.php" class="btn" name="btn__nuevo">ver llamados de atencion </a>
					<a href="verRetardos_seguridad.php" class="btn" name="btn__nuevo">ver retardos  </a>
