		...
		<div class="container1 logo-nav-container">
			...
			<nav class="navegation">
				...
				<ul>
					...
					<li class="Inicio"><a href="controlEgresoEstudiante.php">asisitencia de salida</a></li>
...
<h1 align="center"  style="color:#00F6FE;"> Asistencia entrada Estudiantes</h1>
   <br />
		...
		<div class="contenedor">
			...
			<div class="barra__buscador">
				<form action="" class="formulario" method="POST">
					...
					<a href="retardos_estudiantes.php" class="btn" name="btn__nuevo">Generar Retardos Estudiante </a>
